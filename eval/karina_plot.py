...
def genfig(prop):
    ...
    g = sns.catplot(data=df, x=idtostr(prop), y="value", hue="Race", 
                    col="Method", kind="box", sharey=False)
    g.set_xticklabels(rotation=90)
    g.set_axis_labels(idtostr(prop), "Mean_P_Diff_Diff")
    plt.tight_layout() 
    plt.savefig(f"../results/{prop}/race/boxplot_race.png")
    plt.clf()
    ...
    g.set_axis_labels(idtostr(prop), "Mean_P_Diff_Diff")
    plt.tight_layout() 
    plt.savefig(f"../results/{prop}/race/boxplot_geo.png")
    plt.clf()
    ...
    if prop != "P21_P101":
        ...
        g.set_axis_labels(idtostr(prop), "Mean_P_Diff_Diff")
        plt.tight_layout() 
        plt.savefig(f"../results/{prop}/gender/boxplot.png")
        plt.clf()
