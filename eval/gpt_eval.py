...
for string in ("", "scaff_"):
	...
	scores_all_english_1, scores_all_english_2 = get_scores(gold_all_english, silver_all_english)
	print(f"Americans: Score 1 is {scores_all_english_1}, \
			Score 2 is {scores_all_english_2}, of {len(gold_all_english)}")
	...
	scores_p101_1, scores_p101_2 = get_scores(gold_p101, silver_p101)
	print(f"P101: Score 1 is {scores_p101_1}, \
			Score 2 is {scores_p101_2}, of {len(gold_p101)}")
	...
	scores_p103_1, scores_p103_2 = get_scores(gold_p103, silver_p103)
	print(f"P103: Score 1 is {scores_p103_1}, \
			Score 2 is {scores_p103_2}, of {len(gold_p103)}")

	gold_all = gold_all_english + gold_p101 + gold_p103
	silver_all = silver_all_english + silver_p101 + silver_p103
	scores_all_1, scores_all_2 = get_scores(gold_all, silver_all)
	print(f"Total: Score 1 is {scores_all_1}, \
			Score 2 is {scores_all_2}, of {len(gold_all)}")
