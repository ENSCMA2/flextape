...
def get_args():
    ...
    # policy
    parser.add_argument(
        '--init-model', type=str, default='EleutherAI/gpt-j-6B', help='language model used for policy.')
    parser.add_argument(
        '--ref-model', type=str, default='EleutherAI/gpt-j-6B', help='language model used for reference policy.')
    parser.add_argument(
